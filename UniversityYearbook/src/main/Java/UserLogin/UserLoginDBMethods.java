...
public class UserLoginDBMethods {
	...
	public UserLoginDBObj getRecordByPrimaryKey(String inUserId, String inUserName, String inUserPswd){
		...
		try{
			...
			String lSqlString =	"select * from admin_login where user_id='"+inUserId+"' and user_name='"+inUserName+"' and new_pswd='"+inUserPswd+"'";
			ResultSet rs  = null;
	...
	public int updateUserLoginByPrimaryKey(UserLoginDBObj inUserLoginDBObj){
		int recupd = 0; 
		String lQuery = "";
		lQuery = lQuery +"update admin_login set old_pswd='"+inUserLoginDBObj.old_pswd+"'  "; 
