					...
					<div class="content" style="box-sizing: content-box !important;">
						<div class="content-left">
							...
							<div class="row2" >
								...
								<form action = "faculty_login" name="form1" method="post">
											...
											<td colspan="2">
												<table border="0" align="center">
													<tr>
														...
														<td align="center"><input type="text" class="form-control" name="fac_id"
														id="fac_id" value="" /></td>
													</tr>
													
													<tr>
														<td>Password</td>
														<td align="center"><input type="password" class="form-control" name="fac_f_name"
													...
													<td></td>													
														<td >
															<input type="submit" class="btn btn-dark" name="submit" id="submit" value="Submit" action="faculty_achievement.jsp"/> 
