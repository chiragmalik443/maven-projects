					...
					<div class="header">
						...
						<div class="topmenu">
							<ul>
								...
								<li><a href="#"
									title="register on behalf of your company"><span>Time
										...
										<tr>
											<td colspan="2">
												<table border="0" align="center">
													...
													<tr>
														<td>User Name</td>
														<td align="center"><input type="text" class="form-control" name="user_name"
															id="user_name" value="" /></td>
													</tr>
													<tr>
														<td>Password</td>
														<td align="center"><input type="password" class="form-control" name="user_pswd"
															id="user_pswd" value="" /></td>
													</tr>
							...
							<div class="mainmenu">
								...
								<ul>
									<li><a href="./hr_user_login.jsp"
										title="for registered employee's only">HR Login</a></li>
									<li><a href="#"
										title="for registered company's only">Employee Registration</a></li>
