...
/**
 * Servlet implementation class hr_user_login
 */
@WebServlet(name="hr_user_login", urlPatterns="/hr_user_login")
public class hr_user_login extends HttpServlet {
...
//		doGet(request, response);
		...
		String target = "/hr_user_login.jsp";
